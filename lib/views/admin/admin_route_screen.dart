...
class _AdminRouteScreenState extends State<AdminRouteScreen> {
  ...
  Future<void> _submit() async {
    ...
    final hours = _durationHoursController.text.trim();
    final minutes = _durationMinutesController.text.trim();
    String durationStr = "";
    if (hours.isNotEmpty && hours != "0") durationStr += "$hours h ";
    if (minutes.isNotEmpty) durationStr += "$minutes m";
    durationStr = durationStr.trim();

    if (durationStr.isEmpty) durationStr = "N/A";
