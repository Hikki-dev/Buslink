  ...
  Widget _buildMobileLayout(
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 0,
        actions: const [_FavoriteRouteButton()],
...
class _BusTicketCardState extends State<_BusTicketCard> {
        ...
        child: isMobile
            ? Column(
                children: [
                  ...
                  _buildBookButton(trip, context, controller, isMobile),
                ],
              )
            : IntrinsicHeight(
                child: Row(
  ...
  Widget _buildBookButton(Trip trip, BuildContext context,
      TripController controller, bool isMobile) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text("LKR ${trip.price.toStringAsFixed(0)}",
              style: GoogleFonts.outfit(
                  fontSize: 24,
                  fontWeight: FontWeight.bold,
                  color: AppTheme.primaryColor)),
